...
function Resume() {
  ...
  const resumeFile = i18n.language === 'en' ? 'https://jkhaimi.github.io/portfolio/JesseHaimi_CV_English.pdf' : 'https://jkhaimi.github.io/portfolio/JesseHaimi_CV_Suomi.pdf';
