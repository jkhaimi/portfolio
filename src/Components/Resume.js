...
function Resume() {
  ...
  const resumeFile = i18n.language === 'en' ? 'https://jkhaimi.github.io/portfolio/JesseHaimi-CV-English.pdf' : 'https://jkhaimi.github.io/portfolio/JesseHaimi-CV-Suomi.pdf';
